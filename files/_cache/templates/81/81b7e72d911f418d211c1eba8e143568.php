...
<div class=\"newbase-section-wrapper\">
    ...
    <form id=\"nb-form-ipbx\" class=\"nb-section-form\" method=\"post\" novalidate
          data-section-key=\"ipbx\"
          data-save-label=\"Salvar IPBX / PABX\">
        ...
        yield "        <div class=\"nb-card mb-4\">
            <div class=\"nb-card-header\">
                ...
                <button type=\"button\"
                        ...
                        data-target-body=\"nb-ramais-body\"
                        data-template=\"nb-tpl-ramal\">
        ...
        yield "        <div class=\"nb-card mb-4\">
            <div class=\"nb-card-header\">
                ...
                <button type=\"button\"
                        ...
                        data-target-body=\"nb-operadoras-body\"
                        data-template=\"nb-tpl-operadora\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["op"]) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "numero_piloto", [], "any", true, true, false, 232)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "numero_piloto", [], "any", false, false, false, 232), "")) : ("")));
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "tipo_tronco", [], "any", true, true, false, 233)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "tipo_tronco", [], "any", false, false, false, 233), "")) : ("")));
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "operadora", [], "any", true, true, false, 234)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "operadora", [], "any", false, false, false, 234), "")) : ("")));
            ...
            yield "][ddr]\"           value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "ddr", [], "any", true, true, false, 235)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "ddr", [], "any", false, false, false, 235), "")) : ("")));
            ...
            yield "][canais]\"        value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "canais", [], "any", true, true, false, 236)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "canais", [], "any", false, false, false, 236), "")) : ("")));
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "ip_proxy", [], "any", true, true, false, 237)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "ip_proxy", [], "any", false, false, false, 237), "")) : ("")));
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "porta_proxy", [], "any", true, true, false, 238)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "porta_proxy", [], "any", false, false, false, 238), "")) : ("")));
            yield "\"   placeholder=\"5060\"></td>
                                <td><input type=\"text\"   class=\"form-control form-control-sm\" name=\"operadoras[";
            // line 239
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 239), "html", null, true);
            yield "][ip_audio]\"      value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["op"], "ip_audio", [], "any", true, true, false, 239)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["op"], "ip_audio", [], "any", false, false, false, 239), "")) : ("")));
            yield "\"      placeholder=\"192.x.x.x\"></td>
                                <td>
                                    <button type=\"button\" class=\"btn btn-sm btn-ghost-danger nb-btn-remove-row\" title=\"Remover\">
                                        <i class=\"ti ti-trash\"></i>
        ...
        if (!$context['_iterated']) {
            // line 247
            yield "                            <tr id=\"nb-operadoras-empty\" class=\"nb-empty-row\">
    ...
    ";
        // line 299
        yield "    <template id=\"nb-tpl-operadora\">
        <tr class=\"nb-dyn-row\">
...
";
        // line 319
        yield from         $this->loadTemplate("@newbase/companydata/sections/_shared_js.html.twig", "@newbase/companydata/sections/ipbx_pabx.html.twig", 319)->unwrap()->yield($context);
        return; yield '';
    }
    ...
    {
        return array (  529 => 319,  526 => 318,  506 => 299,  482 => 276,  479 => 274,  468 => 262,  465 => 258,  463 => 257,  458 => 253,  447 => 247,  424 => 239,  418 => 238,  412 => 237,  406 => 236,  400 => 235,  394 => 234,  388 => 233,  382 => 232,  379 => 231,  361 => 230,  331 => 202,  328 => 198,  326 => 197,  321 => 193,  310 => 186,  287 => 178,  281 => 175,  277 => 174,  273 => 173,  266 => 171,  260 => 170,  254 => 169,  248 => 168,  242 => 167,  239 => 166,  221 => 165,  192 => 138,  189 => 134,  187 => 133,  185 => 132,  179 => 128,  165 => 117,  150 => 105,  137 => 95,  122 => 83,  110 => 74,  98 => 65,  86 => 56,  74 => 47,  60 => 35,  55 => 30,  51 => 29,  47 => 28,  38 => 21,);
    }
