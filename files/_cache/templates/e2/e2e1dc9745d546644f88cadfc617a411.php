...
/* @newbase/companydata/sections/_systems_js.html.twig */
class __TwigTemplate_a7ac80ab18f3785545609dae380108f3 extends Template
{
    private $source;
    private $macros = [];
...
(function (\$) {
    ...
    /**
     * Renumera índices nos atributos name= de uma tbody após remoção de linha.
     * Substitui [N][ pelo índice correto baseado na posição da <tr>.
    ...
    /**
     * Gera HTML de uma linha de ramal vazia para a tabela IPBX/PABX.
     * @param {number} idx — Índice da nova linha
    ...
    function novaLinhaRamal(idx) {
        ...
        return '<tr class=\"nb-ramal-row nb-row-new\">'
            ...
            + '<td><button type=\"button\" class=\"btn btn-sm btn-danger nb-remove-row\" data-body=\"nb-ipbx-ramais-body\" title=\"Remover ramal\"><i class=\"ti ti-trash\"></i></button></td>'
            + '</tr>';
    }

    /**
     * Gera HTML de uma linha de operadora vazia para a tabela de troncos.
     * @param {number} idx — Índice da nova linha
     * @returns {string} HTML da <tr>
     */
    function novaLinhaOperadora(idx) {
        ...
        return '<tr class=\"nb-op-row nb-row-new\">'
            ...
            + '<td><button type=\"button\" class=\"btn btn-sm btn-danger nb-remove-row\" data-body=\"nb-ipbx-ops-body\" title=\"Remover operadora\"><i class=\"ti ti-trash\"></i></button></td>'
            + '</tr>';
    }
    ...
    \$(document).off('submit.nbSystems').on('submit.nbSystems', '#nb-systems-form', function (e) {
        e.preventDefault();

        var \$form = \$(this);
        var \$btn  = \$form.find('.nb-save-btn');
        ...
        \$.ajax({
            ...
            success : function (res) {
                ...
                if (res && res.success) {
                    _nbNotify(res.message || 'Configurações salvas com sucesso!', 'success');
                } else {
    ...
    // ── Notificação: SweetAlert2 > toast GLPI > alert nativo ────────────────
    ...
    // ── Injetar CSS de animação spin (uma única vez no DOM) ──────────────────
...
";
    ...
    {
        return "@newbase/companydata/sections/_systems_js.html.twig";
    }
    ...
    {
        return new Source("", "@newbase/companydata/sections/_systems_js.html.twig", "D:\\laragon\\www\\glpi\\plugins\\newbase\\templates\\companydata\\sections\\_systems_js.html.twig");
    }
}
