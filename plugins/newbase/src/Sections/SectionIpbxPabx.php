 ...
 * SectionIpbxPabx
 *
 * Responsável por carregar e exibir a aba "IPBX / PABX" dentro
 * do formulário de CompanyData.
 *
 * Tabela gerenciada: glpi_plugin_newbase_ipbx
 * Template         : @newbase/companydata/sections/ipbx_pabx.html.twig
 *
 * @package GlpiPlugin\Newbase\Sections
 */
class SectionIpbxPabx
{
    /** Nome da tabela gerenciada por esta seção */
    private const TABLE = 'glpi_plugin_newbase_ipbx';

    /** Chave de seção enviada ao endpoint AJAX */
    public const SECTION_KEY = 'ipbx';

    /** Template Twig relativo ao namespace @newbase */
    private const TEMPLATE = '@newbase/companydata/sections/ipbx_pabx.html.twig';
     ...
     *
     * Carrega os dados da tabela glpi_plugin_newbase_ipbx para a empresa
     ...
     *
     * Chamado por ajax/systemsConfig.php quando section_key === 'ipbx'.
     *
